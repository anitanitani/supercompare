...
const BASE_URL = 'https://supermercado.laanonimaonline.com';

export async function scrapeAnonima(searchTerm) {
  const results = [];
  ...
  if (!results.length) {
    throw new Error('Sin resultados en La Anónima — puede que los selectores CSS hayan cambiado.');
  }
