...
export async function scrapeCarrefour(searchTerm) {
  const results = [];
  ...
  try {
    ...
    console.error('[carrefour] Falló API clásica:', err.message);
    ...
    try {
      ...
      throw new Error('No se pudo obtener datos de Carrefour: ' + err2.message);
    }
  }
